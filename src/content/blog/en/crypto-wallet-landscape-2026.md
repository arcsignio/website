...
| Stat | Detail |
| :--- | :--- |
| **500M+** | Global crypto wallet users |
| **200+** | Major wallet brands |
| **62%** | Users prefer self-custody |
...
> **MetaMask — Browser Extension / Mobile App | Hot Wallet**
>
...
> **Trust Wallet — Mobile App / Browser Extension | Hot Wallet**
>
...
> **Phantom — Browser Extension / Mobile App | Hot Wallet**
>
...
> **Keystone (Pro / 3) — Air-Gapped Hardware Device | Hardware Wallet**
>
...
> **Considerations**
>
> Fully open source (Apache 2.0), requires desktop environment, brand awareness still growing
...
> **Fireblocks — Institutional MPC Platform | MPC Wallet**
>
...
ArcSign is one of the few completely free cold storage solutions available today. It transforms any USB drive into a cold wallet, supports 7 EVM chains (ETH, BSC, Avalanche, and more), and provides encrypted backup file functionality. It is fully open source under Apache 2.0.
