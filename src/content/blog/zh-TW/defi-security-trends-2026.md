...
> **ArcSign 用戶提示**
>
> 使用 ArcSign 的跨鏈功能時，你的交易透過 USB [冷錢包](/blog/what-is-cold-storage)簽署，[私鑰](/blog/private-key-management-best-practices)永遠不會暴露。即使橋的前端被[釣魚攻擊](/blog/phishing-attack-prevention)替換，攻擊者也無法在未經你確認的情況下取得你的私鑰。ArcSign 支援 ETH、BSC、Polygon、Arbitrum、Optimism、Base、Avalanche 七條 EVM 鏈。
...
> **B — 形式化驗證（Formal Verification）普及**
>
