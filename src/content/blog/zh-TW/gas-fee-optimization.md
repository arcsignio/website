...
> **風險提醒**
>
> L2 與替代鏈雖然便宜，但各有自身的安全假設：排序器中心化、[跨鏈](/blog/arcsign-cross-chain-guide)橋風險、驗證者集中度等。**大額資產仍建議留在主網的[冷錢包](/blog/what-is-cold-storage)中**，日常操作與實驗性部位再搬到 L2。ArcSign 讓你用同一組[助記詞](/blog/seed-phrase-backup-guide)管理 7 條鏈，可以很方便地採用「分層存放」策略。
...
> **延伸閱讀**
>
> 想更深入了解多鏈操作？請看：[跨鏈操作輕鬆學：用 ArcSign 管理 7 條 EVM 鏈](/blog/arcsign-cross-chain-guide)、[Polygon & BSC 上的 Swap 操作教學](/blog/polygon-bsc-swap-guide)、[ETH + BSC + Avalanche 一站管理](/blog/multi-chain-management)。
