...
**1. 在 Lido / Aave / Pendle 網站上點選「Connect Wallet」**
...
> **延伸閱讀**
>
> 想更深入了解 ArcSign 如何同時管理多條鏈的 DeFi 資產？參考我們的[跨鏈操作教學](/blog/arcsign-cross-chain-guide)，了解如何用同一組助記詞管理 7 條主流 EVM 鏈的資產。對於 ETH 質押的完整教學，可參考[用 ArcSign 質押 ETH 賺取被動收入](/blog/eth-staking-arcsign)。
