...
| **支援的區塊鏈** | ETH、BSC、Polygon、Arbitrum、Optimism、Base、Avalanche | BTC、ETH 及多種山寨幣 | BTC、ETH 及多種山寨幣 |
| **EVM 多鏈原生支援** | 7 條 EVM 鏈原生支援 | 透過 MetaMask 橋接 | 透過 MetaMask 橋接 |
...
| **開源韌體** | ✓ 完全開源（Apache 2.0） | 是——完全開源 | 是——完全開源 |
...
**你現在就需要經審計的開源韌體。**Trezor 的韌體完全開源，已被社群和安全研究人員審計超過十年。ArcSign 已採 Apache 2.0 全開源，原始碼公開可審計。
