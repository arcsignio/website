...
**優點：** 零成本（只需任何 USB）、加密備份、強加密保護、支援 7 條主流 EVM 鏈
...
- **7 條主流 EVM 鏈支援**：Ethereum、BSC、Polygon、Arbitrum、Optimism、Base、Avalanche 一個錢包管理
...
❌ 合理疑慮，但可解決！ArcSign 已採 Apache 2.0 全開源，原始碼公開於 github.com/arcsignio/arcsign，任何人都可以審計。此外，ArcSign 採用的是業界公認的密碼學標準（XOR、[AES-256](/blog/aes256-encryption-simple)、Argon2id），這些演算法已被全球科學界驗證。而且 ArcSign 是零成本方案 — 你沒有任何經濟風險。
...
ArcSign 支援 7 條主流 EVM 相容鏈：Ethereum、BSC、Polygon、Arbitrum、Optimism、Base、Avalanche。使用同一組助記詞，可衍生所有鏈的地址。
